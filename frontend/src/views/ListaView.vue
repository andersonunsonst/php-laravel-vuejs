            ...
            <table class="table mt-5">
                ...
                <tbody>
                    <tr v-for="item in listagem" :key="item.id">
                        ...
                        <td>{{ item.email }}</td>
                        <td>
                            <button @click="getDetalhes(item.id)" type="button" class="btn btn-warning"
                                data-bs-toggle="modal" data-bs-target="#JanelaModal">Detalhar</button>
                                                ...
                                                <table class="table mt-5">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{ moment(detalhesUsuario.created_at).format("YYYY-MM-DD") }}
                                                            </td>
